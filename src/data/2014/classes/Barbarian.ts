...
export const Barbarian: CharacterClass = {
    ...
    subclassLevel: 3,
    // features text verified against 5etools' class-barbarian.json (PHB source) - https://5e.tools/classes.html#barbarian_phb
    features: [
        { name: "Rage", level: 1, description: "In battle, you fight with primal ferocity. On your turn, you can enter a rage as a bonus action.\nWhile raging, you gain the following benefits if you aren't wearing heavy armor:\n• You have advantage on Strength checks and Strength saving throws.\n• When you make a melee weapon attack using Strength, you gain a bonus to the damage roll that increases as you gain levels as a barbarian, as shown in the Rage Damage column of the Barbarian table (+2 at 1st level, +3 at 9th, +4 at 16th).\n• You have resistance to bludgeoning, piercing, and slashing damage.\nIf you are able to cast spells, you can't cast them or concentrate on them while raging.\nYour rage lasts for 1 minute. It ends early if you are knocked unconscious or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.\nOnce you have raged the number of times shown for your barbarian level in the Rages column of the Barbarian table, you must finish a long rest before you can rage again. You can rage twice at 1st level, and this increases as you gain levels, becoming unlimited at 20th level." },
        ...
        { name: "Feral Instinct", level: 7, description: "Your instincts are so honed that you have advantage on initiative rolls. Additionally, if you are surprised at the beginning of combat and aren't incapacitated, you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn." },
        { name: "Ability Score Improvement", level: 8, description: "When you reach 4th level, and again at 8th, 12th, 16th, and 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1 each. As normal, you can't increase an ability score above 20 using this feature." },
        { name: "Brutal Critical (1 die)", level: 9, description: "You can roll one additional weapon damage die when determining the extra damage for a critical hit with a melee attack." },
        ...
        { name: "Brutal Critical (2 dice)", level: 13, description: "The number of additional weapon damage dice you roll for a critical hit with a melee attack increases from one to two." },
        { name: "Persistent Rage", level: 15, description: "Your rage is now so fierce that it ends early only if you fall unconscious or if you choose to end it." },
        { name: "Ability Score Improvement", level: 16, description: "When you reach 4th level, and again at 8th, 12th, 16th, and 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1 each. As normal, you can't increase an ability score above 20 using this feature." },
        { name: "Brutal Critical (3 dice)", level: 17, description: "The number of additional weapon damage dice you roll for a critical hit with a melee attack increases from two to three." },
        ...
        { name: "Primal Champion", level: 20, description: "You embody the power of the wilds. Your Strength and Constitution scores increase by 4. Your maximum for those scores is now 24." },
    ],
};
