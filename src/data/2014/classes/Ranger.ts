...
import { RANGER_FIGHTING_STYLES_2014 } from "@/data/2014/fightingStyles/FightingStyles";
...
export const Ranger: CharacterClass = {
    ...
    // Basic Rules 2014 source, "Table: The Ranger") - https://roll20.net/compendium/dnd5e/Classes:Ranger
    // Corrected from an earlier pass: Natural Explorer was missing its "proficiency bonus is
    // doubled" clause for Intelligence/Wisdom checks related to your favored terrain; Spellcasting
    // had been reduced to a stub pointing at "the Spells section of this sheet" instead of the
    // actual rules text (spell slots, spells known, and the ability to swap a known spell on
    // level-up). Favored Enemy, Fighting Style, Primeval Awareness, Ability Score Improvement,
    // Extra Attack, the combined level 6 improvements, Land's Stride, Hide in Plain Sight, the
    // level 10 Natural Explorer improvement, Vanish, the level 14 Favored Enemy improvement, Feral
    // Senses, and Foe Slayer were already accurate and are unchanged.
    features: [
        ...
        { name: "Natural Explorer", level: 1, description: "You are particularly familiar with one type of natural environment and are adept at traveling and surviving in such regions. Choose a favored terrain type. When you make an Intelligence or Wisdom check related to your favored terrain, your proficiency bonus is doubled if you are using a skill that you're proficient in. While traveling for an hour or more in it you gain a suite of benefits (difficult terrain doesn't slow your group's travel, your group can't become lost except by magical means, you remain alert to danger even while doing other tasks, you can move stealthily at a normal pace when alone, you find twice as much food when foraging, and you learn the number of creatures, their sizes, and the direction they moved if you are tracking others). You choose an additional favored terrain at 6th and 10th level." },
        { name: "Fighting Style", level: 2, description: "You adopt a particular style of fighting as your specialty, such as Archery, Defense, Dueling, or Two-Weapon Fighting. You can't take the same Fighting Style option more than once, even if you get to choose again from a different class feature.", choice: { key: "fightingStyle", prompt: "Choose your Fighting Style", options: RANGER_FIGHTING_STYLES_2014 } },
        ...
        { name: "Favored Enemy and Natural Explorer Improvements", level: 6, description: "You choose an additional favored enemy, as well as an associated language.\nYou also choose an additional favored terrain." },
        ...
        { name: "Natural Explorer Improvement", level: 10, description: "You choose an additional favored terrain." },
