...
import { PALADIN_FIGHTING_STYLES_2014 } from "@/data/2014/fightingStyles/FightingStyles";
...
export const Paladin: CharacterClass = {
    ...
    features: [
        ...
        { name: "Fighting Style", level: 2, description: "You adopt a particular style of fighting as your specialty, such as Defense, Dueling, Great Weapon Fighting, or Protection. You can't take the same Fighting Style option more than once, even if you get to choose again from a different class feature.", choice: { key: "fightingStyle", prompt: "Choose your Fighting Style", options: PALADIN_FIGHTING_STYLES_2014 } },
