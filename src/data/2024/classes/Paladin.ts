...
import { PALADIN_FIGHTING_STYLES_2024 } from "@/data/2024/fightingStyles/FightingStyles";
...
export const Paladin: CharacterClass = {
    ...
    features: [
        ...
        { name: "Fighting Style", level: 2, description: "You gain a Fighting Style feat of your choice. Instead of choosing one of those feats, you can choose the Blessed Warrior feat.", choice: { key: "fightingStyle", prompt: "Choose your Fighting Style", options: PALADIN_FIGHTING_STYLES_2024 } },
        { name: "Paladin's Smite", level: 2, description: "You always have the Divine Smite spell prepared. In addition, you can cast it without expending a spell slot, but you must finish a Long Rest before you can cast it in this way again.", grantedSpells: [{ spellName: "Divine Smite", limit: "once per long rest" }] },
