...
export const Barbarian: CharacterClass = {
    ...
    // 2024 source, "Barbarian Features" table) - https://roll20.net/compendium/dnd5e/Classes:Barbarian
    // Corrected from an earlier pass: Rage's activation/extension/recovery paragraph had been
    // garbled into an inaccurate rewrite (it invented a "someone uses a spell like Bless on you"
    // clause that doesn't exist in the rule, and dropped the "ends early if you don Heavy armor"
    // condition) - replaced with the source's actual wording; Weapon Mastery said you could change
    // "your choices" (plural) per long rest, when the rule only lets you change ONE weapon choice;
    // Reckless Attack incorrectly restricted the Advantage to "melee attack rolls" when 2024 applies
    // it to any Strength-based attack roll; Primal Knowledge incorrectly restricted its Strength-swap
    // to "proficient" skills, which isn't in the rule; Feral Instinct still carried over the 2014-only
    // "surprised at the start of combat" clause, which the 2024 revision dropped entirely; Persistent
    // Rage was missing its "or don Heavy armor" early-end condition; and the level-17 Improved Brutal
    // Strike had an invented "or the same effect twice" clause not present in the source.
    features: [
        { name: "Rage", level: 1, description: "You can imbue yourself with a primal power called Rage, a force that grants you extraordinary might and resilience. You can enter it as a Bonus Action if you aren't wearing Heavy armor.\nYou can enter your Rage the number of times shown for your Barbarian level in the Rages column of the Barbarian table. You regain one expended use when you finish a Short Rest, and you regain all expended uses when you finish a Long Rest.\nWhile active, your Rage follows the rules below.\nDamage Resistance: You have Resistance to Bludgeoning, Piercing, and Slashing damage.\nRage Damage: When you make an attack using Strength - with either a weapon or an Unarmed Strike - and deal damage to the target, you gain a bonus to the damage that increases as you gain levels as a Barbarian, as shown in the Rage Damage column of the Barbarian table (+2 at level 1, +3 at level 9, +4 at level 16).\nStrength Advantage: You have Advantage on Strength checks and Strength saving throws.\nNo Concentration or Spells: You can't maintain Concentration, and you can't cast spells.\nDuration: The Rage lasts until the end of your next turn, and it ends early if you don Heavy armor or have the Incapacitated condition. If your Rage is still active on your next turn, you can extend it for another round by making an attack roll against an enemy, forcing an enemy to make a saving throw, or taking a Bonus Action to extend it. Each time the Rage is extended, it lasts until the end of your next turn. You can maintain a Rage for up to 10 minutes." },
        { name: "Unarmored Defense", level: 1, description: "While you aren't wearing any armor, your base Armor Class equals 10 plus your Dexterity and Constitution modifiers. You can use a Shield and still gain this benefit." },
        { name: "Weapon Mastery", level: 1, description: "Your training with weapons allows you to use the mastery properties of two kinds of Simple or Martial Melee weapons of your choice, such as Greataxes and Handaxes. Whenever you finish a Long Rest, you can practice weapon drills and change one of those weapon choices. When you reach certain Barbarian levels, you gain the ability to use the mastery properties of more kinds of weapons, as shown in the Weapon Mastery column of the class table." },
        ...
        { name: "Primal Knowledge", level: 3, description: "You gain proficiency in another skill of your choice from the skill list available to Barbarians at level 1.\nIn addition, while your Rage is active, you can channel primal power when you attempt certain tasks; whenever you make an ability check using one of the following skills, you can make it as a Strength check even if it normally uses a different ability: Acrobatics, Intimidation, Perception, Stealth, or Survival. When you use this ability, your Strength represents primal power coursing through you, honing your agility, bearing, and senses." },
