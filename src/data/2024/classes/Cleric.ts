...
export const Cleric: CharacterClass = {
    ...
    features: [
        ...
        { name: "Divine Order", level: 1, description: "You have dedicated yourself to one of the following sacred roles of your choice.\nProtector: you gain proficiency with Martial weapons and training with Heavy armor.\nThaumaturge: you learn one extra cantrip from the cleric spell list, and you gain a bonus to your Intelligence (Arcana or Religion) checks equal to your Wisdom modifier (minimum +1).", choice: { key: "divineOrder", prompt: "Choose your Divine Order", options: [
            { id: "protector", label: "Protector", summary: "Martial weapon proficiency and Heavy armor training." },
            { id: "thaumaturge", label: "Thaumaturge", summary: "Learn 1 extra cleric cantrip; bonus to Arcana/Religion checks equal to your Wisdom modifier.", grantedSpells: [{ choice: { count: 1, spellLevel: 0 }, limit: "always known" }] },
        ] } },
